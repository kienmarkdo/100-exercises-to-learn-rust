...
#[test]
fn works() {
    let store = Arc::new(RwLock::new(TicketStore::new())); // TODO: everyone has access to the store with Arc. Thread-safe thread counter, if it drops to 0, the contents will be dropped.
