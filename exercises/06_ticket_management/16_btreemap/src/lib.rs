...
#[derive(Clone, Copy, Debug, PartialEq, Ord, PartialOrd, Eq)] // added Ord, PartialOrd, Eq
...
impl TicketStore {
    pub fn new() -> Self {
        Self {
            tickets: BTreeMap::new(), // todo!() make a new empty BTreeMap
            counter: 0,
        }
    }
    ...
    pub fn add_ticket(&mut self, ticket: TicketDraft) -> TicketId {
        ...
        // todo!() insert the ticket into the BTreeMap
        self.tickets.insert(id, ticket);

        // id of the ticket that was just inserted
        id
    }
...
// todo!()'d this whole IntoIterator trait
